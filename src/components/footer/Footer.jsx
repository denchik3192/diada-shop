  ...
  return (
    <div class="flex items-end w-full  bg-white ">
      <footer class=" w-full text-gray-700 bg-gray-100 body-font">
        <div class="container flex justify-between flex-wrap px-10 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap md:px-4 md:py-4">
          <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <p class="mt-2 text-sm text-gray-500">Цитата!</p>
            <div class="mt-4">
          ...
          <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center  md:mt-0 md:text-left">
            ...
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
              ...
              <nav class="mb-10 list-none">
                <li class="mt-3">
                  <a class="text-gray-500 cursor-pointer hover:text-gray-900">+7(999) 895-01-11</a>
                </li>
                <li class="mt-3">
                  <a class="text-gray-500 cursor-pointer hover:text-gray-900">
                    club_diada2024@mail.ru
                  </a>
                </li>
              </nav>
            </div>
